...
public class DownloadInvoiceTest extends BaseTest {
	...
	@Test
	public void downloadInvoiceAPurchase() {
		LogUtil.info("Dwonloading Invoice after purchasing product test has begun (Test case 24).");
		try {
			...
			values=signUpLoginPage.signupNameAndEmail("Yash N", "yashu108@gmail.com");
			...
			dashBoardPage.clickOnDownloadInvoice();
		...
		LogUtil.info("Dwonloading Invoice after purchasing product test has ended (Test case 24).");
	}
}
